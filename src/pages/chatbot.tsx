...
useEffect(() => {
  ...
  return (
    <div className="pt-[10px] pb-[90px] px-4 bg-white min-h-screen flex flex-col items-center">
      ...
      <div
        ref={containerRef}
        className="w-full max-w-[527px] flex-1 overflow-y-auto flex flex-col space-y-2"
      >
      ...
      {/* 입력창 */}
      <div className="fixed bottom-3 flex flex-col justify-start left-1/2 -translate-x-1/2 z-10 w-full max-w-[550px] flex items-center space-x-2 px-4 bg-[#FFFFFF] h-[80px]">
