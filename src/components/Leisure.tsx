...
const Leisure: React.FC<LeisureProps> = ({
  ...
  return (
    <div className="w-[230px] h-[390px] border rounded-lg">
      <button
        onClick={detailClick}
        className="mt-[10px] flex flex-row justify-center items-center w-[170px] h-[226px] bg-[#FFFFFF] overflow-hidden relative"
      >
        <Image
          src={image_url}
          alt="포스터"
